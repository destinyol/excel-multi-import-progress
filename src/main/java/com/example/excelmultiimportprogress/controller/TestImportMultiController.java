...
/**
 * 批量导入示例controller
 *      实现handle的handleMultiDataAndSave方法
 */
@RestController
@RequestMapping("/testMulti")
public class TestImportMultiController {
    ...
    public Response importExcel(MultipartFile file){
        ...
        try {
            ...
            String processKey = ExcelImportMainTool.buildImport(CustomerImportDto.class, handler, redisTemplate).setBatchInsertCount(250).runAsyncMulti(file);
